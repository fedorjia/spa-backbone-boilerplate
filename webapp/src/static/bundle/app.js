...
$(function () {
       ...
       if (_config2.default.isActiveRouter) {
              _router2.default.start(_router4.default);
       } else {
              _viewport2.default.fly(_home2.default);
       }
}());

},{"./container/home":9,"./router":25,"framework/config":13,"framework/router":19,"framework/viewport":21}],3:[function(require,module,exports){
'use strict';
...
var _cart = require('../../container/cart');

var _cart2 = _interopRequireDefault(_cart);

var _cartStore = require('generic/cart-store');
...
},{"../../container/cart":7,"framework/config":13,"generic/cart-store":22}],4:[function(require,module,exports){
'use strict';
...
var _fetch = require('generic/fetch');
...
var Infinite = function () {
    ...
    _createClass(Infinite, [{
        ...
        value: function load() {
            ...
            _fetch2.default.get(this.options.url, params).then(function (res) {
                if (res.status !== 200) {
...
},{"generic/fetch":23}],5:[function(require,module,exports){
'use strict';
...
},{"generic/cart-store":22}],6:[function(require,module,exports){
...
var _component = require('framework/component');

var _component2 = _interopRequireDefault(_component);

var _handler = require('generic/handler');
...
var _confirm = require('widget/confirm');
...
},{"./cart-item":5,"./cart.html":6,"framework/component":12,"framework/config":13,"generic/cart-store":22,"generic/handler":24,"widget/confirm":26}],8:[function(require,module,exports){
module.exports = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div class="wrapper">\n    <ul class="items"></ul>\n</div>\n';
...
var _cartOverlay = require('component/cart-overlay');
...
},{"./home.html":8,"./product-item":10,"component/cart-overlay":3,"component/infinite":4,"framework/component":12,"generic/handler":24}],10:[function(require,module,exports){
'use strict';
...
},{"generic/cart-store":22}],11:[function(require,module,exports){
'use strict';
...
},{"./anime":11,"./viewport":21}],15:[function(require,module,exports){
'use strict';
...
},{"../../anime":11}],16:[function(require,module,exports){
'use strict';
...
},{"../../anime":11}],18:[function(require,module,exports){
'use strict';
...
},{"../../anime":11}],19:[function(require,module,exports){
'use strict';
...
},{"./config":13,"./transition":20,"./viewport":21}],20:[function(require,module,exports){
'use strict';
...
},{"./config":13,"./plugin/transition/FadeTransition":15,"./plugin/transition/NoneTransition":16,"./plugin/transition/SlideHorizontalTransition":17,"./plugin/transition/SlideVerticalTransition":18}],21:[function(require,module,exports){
'use strict';
...
},{"./config":13,"./router":19,"./transition":20}],22:[function(require,module,exports){
'use strict';
...
},{"whatwg-fetch":1}],24:[function(require,module,exports){
"use strict";
...
var _home = require('./container/home/home');

var _home2 = _interopRequireDefault(_home);

var _cart = require('./container/cart/cart');
...
},{"./container/cart/cart":7,"./container/home/home":9,"./framework/router":19}],26:[function(require,module,exports){
'use strict';
...
var _modal = require('framework/modal');
